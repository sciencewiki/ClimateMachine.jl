            ...
            for i4 in 1:tup[4]
                for i3 in 1:tup[3]
                    for i2 in 1:tup[2]
                        for i1 in 1:tup[1]
                            y[i1, i2, i3, i4, i5, i6] =
                                inverse_entry(i1, i2, i3, i4, i5, i6) *
                                x[i1, i2, i3, i4, i5, i6]
                        end
                    end
                end
...
method(x, tol) = ColumnwisePreconditionedConjugateGradient(
    x,
...
y = copy(x)
iters = linearsolve!(
    more_complicated_linear_operator!,
    linearsolver,
    x,
    y;
    max_iters = Inf,
...
new_inverse_linear_operator! =
    closure_even_more_complicated_inverse_linear_operator!(inv_A)
